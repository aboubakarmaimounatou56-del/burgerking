<?php
  require 'database.php';
    ...
    if(!empty($_POST))
    {
        ...
        if(($isSuccess && $isImageUpdated && $isUploadSuccess) || ($isSuccess && !$isImageUpdated)) // Fixed !isImageUpdated
        {
            $db = Database::connect();
            if($isImageUpdated)
            {
...
<html>
<head>
    <title>Burger Code - Administration</title>
    <meta charset="UTF-8">
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <form class="form" role="form" action="<?php echo 'update.php?id=' . $id; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="price">Prix: (en Xaf)</label>
            ...
            <div class="col-sm-6 site">
                <div class="thumbnail">
                    ...
                    <div class="price"><?php echo number_format((float)$price, 2, '.', '') . ' Xaf'; ?></div>
                    <div class="caption">
                        <h4><?php echo $name; ?></h4>
